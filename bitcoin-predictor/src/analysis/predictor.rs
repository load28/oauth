...
use crate::analysis::{SentimentAnalyzer, TechnicalAnalyzer};
...
impl PredictionEngine {
    ...
    /// 종합 예측 수행
    pub async fn predict(&self) -> Result<PredictionResult> {
        info!("Starting Bitcoin price prediction...");
